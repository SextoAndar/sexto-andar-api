...
async def remove_from_favorites(
    ...
    **Error responses:**
    ...
    """
    favorite_service = FavoriteService(db)
    favorite_service.remove_favorite(user_id=current_user.id, property_id=property_id)
...
@router.get(
    "/", response_model=FavoriteListResponse, summary="View My Favorite Properties"
)
...
async def check_favorite_status(
    ...
    **Returns:** Status indicating if property is favorited
    ...
    return FavoriteStatusResponse(
        message="Property is favorited"
        if is_favorited
        else "Property is not favorited",
        property_id=property_id,
...
@router.get(
    "/count/total", response_model=FavoritesCountResponse, summary="Get Favorites Count"
)
