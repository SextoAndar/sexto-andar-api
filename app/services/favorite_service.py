...
class FavoriteService:
    ...
    def add_favorite(self, user_id: UUID, property_id: UUID) -> Favorite:
        ...
        # Create favorite
        favorite = Favorite(idUser=user_id, idProperty=property_id)

        return self.repository.create(favorite)

    def remove_favorite(self, user_id: UUID, property_id: UUID) -> None:
    ...
    def get_user_favorites(
        ...
        return self.repository.get_by_user(
            user_id=user_id, page=page, size=size, active_only=active_only
        )
