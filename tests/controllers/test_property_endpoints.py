...
class TestPropertyCreation:
    ...
    def test_create_apartment_success(
        self, authenticated_property_owner, test_apartment_data
    ):
    ...
    def test_create_house_invalid_sales_type(
        self, authenticated_property_owner, test_house_data
    ):
    ...
    def test_create_apartment_missing_floor(
        self, authenticated_property_owner, test_apartment_data
    ):
...
class TestPropertyOwnerPortfolio:
    ...
    def test_get_my_properties(
        self, authenticated_property_owner, db_session, test_house_data
    ):
    ...
    def test_get_my_properties_filter_by_type(
        self, authenticated_property_owner, db_session, test_house_data
    ):
    ...
    def test_get_portfolio_statistics(
        self, authenticated_property_owner, db_session, test_house_data
    ):
...
class TestPropertyUpdate:
    ...
    def test_update_property_success(
        self, authenticated_property_owner, created_property
    ):
...
class TestPropertyDeletion:
    ...
    def test_deactivate_property_success(
        self, authenticated_property_owner, created_property
    ):
    ...
    def test_reactivate_property_success(
        self, authenticated_property_owner, db_session, test_house_data
    ):
